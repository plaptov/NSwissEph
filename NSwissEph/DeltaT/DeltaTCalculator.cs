...
{
	public static class DeltaTCalculator
	{
		...
		public static double Calc(JulianDayNumber julianDay, DeltaTMode deltaTMode = DeltaTMode.None, EphemerisMode? ephemerisMode = null)
		{
